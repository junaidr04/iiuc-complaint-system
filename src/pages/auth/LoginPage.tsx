...
import { Eye, EyeOff, GraduationCap, LogIn, Loader2, Moon, Sun } from 'lucide-react';
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex w-1/2 bg-primary flex-col justify-between p-12">
        <div className="flex items-center gap-3">
          ...
          <span className="text-lg font-semibold text-[#efd6d6] bg-[#a5161600] bg-none">{"IIUC Complaint Management System"}</span>
        </div>
        <div className="space-y-4">
          ...
          <p className="text-primary-foreground/70 text-base">
            Submit, track, and resolve university complaints — transparently and efficiently.
          </p>
        </div>
